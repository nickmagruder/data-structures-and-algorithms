...
const templateWithJQuery = () => {
  for 
  const starWarsSection = $('#template').clone();
  $starWarsSection.find('h2').text(starWarsPeople.name);
  $starWarsSection.find('h3').text(starWarsPeople.height);
  $starWarsSection.find('p').text(starWarsPeople.eye_color);
  console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!', $starWarsSection);
  $('section').append($starWarsSection);
}
