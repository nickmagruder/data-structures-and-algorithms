...
$('form').html('<button name="submit">submit</button>');
}
...
// answer adapted from Damjan Pavlica and Zon on Stack Overflow: https://stackoverflow.com/questions/5778020/check-whether-an-input-string-contains-a-number-in-javascript
const isNum = (input) => {
return /\d/.test(input);
};
